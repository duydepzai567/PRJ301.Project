 ...
 * @author DUCDUY2003
 */
@WebServlet(name = "ProductTypeContrller", urlPatterns = {"/prolist"})
public class ProductTypeContrller extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("ProductTypeList.jsp").forward(request, response);
